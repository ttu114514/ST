...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_path', type=str, default='./asserts/1803240808-00000109.jpg', help='test image path')
    parser.add_argument('--private_key', type=str, default='there is a woman holding up an award and some bottles', help='text prompt of the private key')
    parser.add_argument('--public_key', type=str, default='there is a man holding up an award and some bottles', help='text prompt of the public key')
    parser.add_argument('--save_path', type=str, default='./output/180', help='text prompt of the public key')
